...
@section('content')
    <x-admin-shell lang="es">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900 mb-1">Historial de pagos remotos</h1>
                <p class="text-gray-600">Trazabilidad de referencias SumUp y acciones de verificación.</p>
            </div>
