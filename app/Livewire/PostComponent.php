...
class PostComponent extends Component
{
    ...
    // NOTE: this override disables the permission checks made through
    // $this->authorize(). Kept as-is during the Laravel 13 upgrade to preserve
    // the previous behaviour; the signature only matches Livewire\Component.
    ...
    public function storeData()
    {
        ...
        if ($this->newImage->getMimeType() && strpos($this->newImage->getMimeType(), 'image') !== false) {
            ...
            // Redimensionar la imagen si excede 700px, manteniendo la relación de aspecto
            $imageInstance = Image::read('storage/posts/'.$imageHashName);
            $imageInstance->scaleDown(700, 700);
